...
const routesday20250109: Array<RouteRecordRaw> = [
  {
    path: '/StuDemo60',
    name: 'dayStuDemo60',
    component: () => import('@/views/day20250109/StuDemo60.vue'), // 按需加载
  },
  {
    path: '/StuDemo61',
    name: 'dayStuDemo61',
    component: () => import('@/views/day20250109/StuDemo61.vue'), // 按需加载
  },
]
// day20250110
const routesday20250110: Array<RouteRecordRaw> = [
  {
    path: '/StuDemo62',
    name: 'dayStuDemo62',
    component: () => import('@/views/day20250110/StuDemo62.vue'), // 按需加载
  },
  {
    path: '/StuDemo63',
    name: 'dayStuDemo63',
